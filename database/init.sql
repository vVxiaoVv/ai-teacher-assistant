...
-- 插入5条火影忍者角色测试数据（username使用中文，使用真实的Q版头像URL）
INSERT INTO `user` (`username`, `password`, `role`, `status`, `avatar_url`, `create_time`, `update_time`) VALUES
                                                                                                              ('漩涡鸣人', '123456', 'user', 'active', 'https://img2.baidu.com/it/u=2282259983,3465502484&fm=253&app=138&f=JPEG?w=500&h=500', NOW(), NOW()),
                                                                                                              ('宇智波佐助', '123456', 'user', 'active', 'https://img1.baidu.com/it/u=3097808718,4220946449&fm=253&app=138&f=JPEG?w=502&h=500', NOW(), NOW()),
                                                                                                              ('春野樱', '123456', 'user', 'active', 'https://ww1.sinaimg.cn/mw690/88a76bfagy1hpod6zz7tvj20wr0wm46n.jpg', NOW(), NOW()),
                                                                                                              ('旗木卡卡西', '123456', 'user', 'active', 'https://gips2.baidu.com/it/u=3192270850,3934380473&fm=3074&app=3074&f=JPEG', NOW(), NOW()),
                                                                                                              ('自来也', '123456', 'user', 'active', 'https://picx.zhimg.com/v2-030fd1405b70e2ce43a406499cf06a9a_r.jpg?source=2c26e567', NOW(), NOW()),
                                                                                                              ('纲手', '123456', 'user', 'active', 'https://img2.baidu.com/it/u=1254216982,210015761&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500', NOW(), NOW()),
                                                                                                              ('大蛇丸', '123456', 'user', 'active', 'https://img1.baidu.com/it/u=1720919251,1803841280&fm=253&app=138&f=JPEG?w=500&h=500', NOW(), NOW()),
                                                                                                              ('我爱罗', '123456', 'user', 'active', 'https://img.bugela.com/uploads/2022/03/10/TX10068_03.jpg', NOW(), NOW())
    ON DUPLICATE KEY UPDATE `update_time` = NOW(), `avatar_url` = VALUES(`avatar_url`);
